...
L.Control.FilterWizard = L.Control.extend({
  ...
  onAdd: function(map) {
    ...
    modal.innerHTML = '<div class="modal-dialog">' +
      ...
      '<div id="filtercount">' +
      'Du har valgt <span class="value">' +
      '0</span> <span class="objectname">objekter</span>.' +
      '</div>' +
      '<button type="button" class="btn btn-warning" id="filterclear">' +
      'Ryd valg' +
      '</button>' +
      '<button type="button" class="btn btn-primary btn-close" ' +
      'data-dismiss="modal" id="filtersubmit">' +
      'Udfør' +
      '</button>' +
      '</div>' +
